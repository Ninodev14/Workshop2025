const recipes = [
...

    {
        ...
        ingredients: [
            ...
            { src: "src/img/ingredients/Kiwi.png", state: 1 },
...

    {
        ...
        ingredients: [
            ...
            { src: "src/img/ingredients/Salade.png", state: 2 },
            { src: "src/img/ingredients/Tomate.png", state: 1 },
    ...
    //PAS TOUS LES INGREIDENTS
...

     {
        ...
        ingredients: [
            ...
            { src: "src/img/ingredients/Jambon.png", state: 1 },
            { src: "src/img/ingredients/Mais.png", state: 2 },
            { src: "src/img/ingredients/PetitPois.png", state: 2 },
            { src: "src/img/ingredients/Carotte.png", state: 1 }
        ]
    },
...

    {
        ...
        ingredients: [
            ...
            { src: "src/img/ingredients/Cafe.png", state: 0 },
...

    {
        ...
        ingredients: [
            ...
            { src: "src/img/ingredients/Noix.png", state: 1 },
            { src: "src/img/ingredients/Citron.png", state: 1 }
        ]
    },
